<?php 
    ...
    if($precedent == "http://localhost/GestCourrier/ajouterSPa.php"){$afficher = "oui";}
...
<body style="background-color: gray;">
    ...
    <div class="container justify-content-center  py-5" style="background-color: whitesmoke;">
        <h4 class="align-items-center justify-content-center p-5">Nouveau paragraphe</h4>
        <?php 
            
            if(isset($_SESSION['msg1']) && isset($afficher)){
                echo " <div class='alert alert-success justify-content-center' role='alert' style='display: flex; text-align: center; width: 50%;'>Le paragraphe a été créé avec succès !</div>";
            }
            if(isset($_SESSION['msg2']) && isset($afficher)){
                echo "<div class='alert alert-danger justify-content-center' role='alert' style='display: flex; text-align: center; width: 50%;'>La creation du paragraphe echouée !</div>";
            }
        ...
        <form class="row g-3" action="controller/creerP.php" method="post">
