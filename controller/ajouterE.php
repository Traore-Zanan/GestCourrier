...
<?php
    ...
    if (isset($_POST['ajouter'])) {
        ...
        if($precedent == "http://localhost/GestCourrier/ajouterE.php"){
            ...
            $resq1 = "INSERT INTO courriers (Expediteur, Destinataire, DateEnvoie, Objet, Corps, Type, delai, Nature) VALUES ('$exp', '$des', '$date', '$ob', '$corps', '$type', '$delai', 'entrant')";
