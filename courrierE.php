...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-white" href="ajouterE.php">Ajouter</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container justify-content-center" style="background-color: whitesmoke; overflow-x: auto" >
        ...
        <div class="container justify-content-center align-items-center p-5">
            <h2 class="align-items-center">COURRIERS ENTRANTS</h2>
        </div>
        <?php include "vues/courrierE.php";?>
  </div>
...
/*
            ...
            $count=1;
             ...
             while ($row=$result-> fetch(PDO::FETCH_ASSOC)) {
                ...
                echo"function afficherPopup".$count."() {
                    var lien1 = document.querySelector('#id".$count."');
...
*/
        ...
        function afficherPopup1() {
            var lien1 = document.querySelector('#id1');
