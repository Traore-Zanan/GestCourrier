<?php 
  ...
  if($precedent == "http://localhost/GestCourrier/courrierS.php"){$afficher = "non";}
...
<body style="background-color: gray;">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-white" href="courrierS.php">Courriers sortant</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container justify-content-center  py-5" style="background-color: whitesmoke;">
        ...
        ?> 
        <form class="row g-3" action="controller/modifierS.php" method="post">
            <div class="col-md-4">
